...
const JobCard = ({job}) => {
    return (
      ...
      <div
        className='w-full md:w-[20rem] 2xl:w-[22rem] h-[16rem] md:h-[18rem] bg-white flex flex-col justify-between shadow-lg rounded-md px-3 py-5'
       >
        ...
        <div className='flex items-center justify-between'>
          <p className='bg-[#fceae8] text-[#E74C3C] py-0.5 px-1.5 rounded font-semibold text-sm'>
            {job?.jobType}
          </p>

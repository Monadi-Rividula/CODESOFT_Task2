        ...
        className={`container mx-auto px-5 ${
          ...
          >
            <div className='w-full z-10'>
                ...
                <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
                    ...
                    <div>
                        ...
                        title='Search'
                        containerStyles={
                        "text-white py-2 md:py3 px-3 md:px-10 focus:outline-none bg-red-600 rounded-full md:rounded-md text-sm md:text-base"
                        }
                    />
                    </div>
                </div>
                   ...
                   {type && (
                        ...
                        {popularSearch.map((search, index) => (
                            <span
                            key={index}
                            className='bg-[#fceae8] text-[#E74C3C] py-1 px-2 rounded-full text-sm md:text-base'
                        >
                            {search}
                            </span>
                        ))}
            ...
            <div className='w-1/3 h-full absolute top-24 md:-top-6 lg:-top-14 right-16 2xl:right-[18rem]'>
                <img src={HeroImage} className='object-contain' height="300" />
            </div>

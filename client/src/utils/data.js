...
export const users = [
  ...
  },
  {
    ...
    location: "Colombo",
    email: "stevejames10@gmail.com",
    contact: "+94004587522",
    about:
      "I am a skilled web developer passionate about creating dynamic and user-centric digital experiences. With 6 month of intern experience in the field, that possess a proven track record of delivering high-quality projects that blend innovation with functionality. I am excels in a variety of programming languages and frameworks, including but not limited to HTML, CSS, JavaScript, React, and Node.js. I am proficient in both front-end and back-end development, adept at translating design concepts into seamless, responsive web applications.",
    profileUrl: User,
    accountType: "seeker",
    cvUrl: "",
    token: "gjhsdgsjgdjh",
